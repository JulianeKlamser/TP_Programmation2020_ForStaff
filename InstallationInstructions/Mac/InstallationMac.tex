...
Vous pouvez installer les outils de la ligne de commande sans Xcode. Pour cela, vous devez lancer l'application appelée Terminal. Cette application se trouve dans /Applications/Utilitaires/. Vous pouvez également la rechercher avec "Spotlight" (cmd + espace ou loupe dans le coin supérieur droit de la barre de menu). Voir aussi \href{https://fr.wikihow.com/ouvrir-le-Terminal-sur-un-Mac}{https://fr.wikihow.com/ouvrir-le-Terminal-sur-un-Mac}.
\begin{figure}[H]
\begin{subfigure}[c]{0.5\textwidth}
\includegraphics[width=1\textwidth]{Plots/Terminal.png}
\subcaption{Applications/Utilitaires/ Voir aussi \href{https://fr.wikihow.com/ouvrir-le-Terminal-sur-un-Mac}{https://fr.wikihow.com/ouvrir-le-Terminal-sur-un-Mac}.}
\end{subfigure}
\begin{subfigure}[c]{0.5\textwidth}
