                 ...
                 int image_width, int image_height)
{
  ...
  cinfo.density_unit = '1'; /* 1=pixel/inch, 2=pixel/cm, 0=pas d'unité */
...

{
	...
	if (buf == NULL || buf->image_buffer == NULL)
		return 0;

	return write_JPEG_file(filename, 
                 		100, 600, 600,
				buf->image_buffer,
				buf->image_width, buf->image_height);
}
