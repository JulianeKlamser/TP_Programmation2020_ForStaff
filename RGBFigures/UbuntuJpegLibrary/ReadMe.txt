...
2) A l'intérieur de "Libraries" se trouve un autre répertoire appelé "src.x86". Naviguez 
votre terminal jusqu'à ce répertoire et tapez "make" pour compiler le code qui s'y 
trouve. 

3) Le résultat de 2) est un fichier "jpeg.a" dans le répertoire "src.x86". Copiez ce 
